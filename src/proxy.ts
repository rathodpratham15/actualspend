...
export const config = {
  matcher: [
    "/((?!api/auth|api/plaid/webhook|api/health|login|register|welcome|privacy|terms|security|_next/static|_next/image|favicon.ico|monitoring|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)",
  ],
};
